...
| Metric                                          | Type      | Labels                        | Description                         |
| ----------------------------------------------- | --------- | ----------------------------- | ----------------------------------- |
| `spacebot_cron_executions_total`                | Counter   | agent_id, task_type, result   | Backward-compatible final cron outcome (`success`/`failure`) |
| `spacebot_cron_delivery_total`                  | Counter   | agent_id, task_type, result   | Cron delivery outcome (`success`/`failure`/`skipped`) |
